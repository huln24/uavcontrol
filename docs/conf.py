...
# -*- coding: utf-8 -*-
"""
uavcontrol documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'uavcontrol'))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, '..'))
sys.path.insert(0, src_path)

import uavcontrol  # noqa
...
project = u'uavcontrol'
_full_version = uavcontrol.__version__
author = uavcontrol.__author__
copyright = uavcontrol.__copyright__
...
htmlhelp_basename = 'uavcontrol-doc'
...
latex_documents = [
    (master_doc, 'uavcontrol.tex', u'uavcontrol Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'uavcontrol', 'uavcontrol Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'uavcontrol', 'uavcontrol Documentation',
     author, 'uavcontrol', uavcontrol.__descr__,
     'Miscellaneous'),
]
